    ...
    public static final JsonAdapter.Factory FACTORY =
            new JsonAdapter.Factory() {
                ...
                public JsonAdapter<?> create(
                    ...
                    if (type == Object.class) return new StandardJsonAdapters.ObjectJsonAdapter(moshi).nullSafe();

                    Class<?> rawType = Types.getRawType(type);

                    JsonAdapter<?> generatedAdapter = generatedAdapter(moshi, type, rawType);
                    ...
                    if (rawType.isEnum()) {
                        ...
                        return new StandardJsonAdapters.EnumJsonAdapter<>((Class<? extends Enum>) rawType).nullSafe();
                    }
                    return null;
                }
            };
